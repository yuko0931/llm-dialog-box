...
<template>
  <div class="sidebar" :class="{ collapsed: isCollapsed, active: mobileActive }">
    <div class="header-container">
      <Logo :is-collapsed="isCollapsed" />
      <div class="sidebar-toggle">
        <MenuFold v-if="!isCollapsed" theme="outline" :size="24" @click="mobileActive = false" />
        <MenuUnfold v-else theme="outline" :size="24" @click="isCollapsed = false" />
      </div>
    </div>
        ...
        <svg viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg"
          ...
          <defs>
            <clipPath id="clip1325_20400">
              <rect id="新建会话0730" width="30.000000" height="30.000000" fill="white" fill-opacity="0"></rect>
            </clipPath>
          </defs>
          <g clip-path="url(#clip1325_20400)">
            ...
            <rect id="rect" x="17.770508" y="6.396484" rx="1.062250" width="8.060087" height="2.124500"
              fill="currentColor" fill-opacity="1.000000"></rect>
            <rect id="rect" x="20.718750" y="3.500000" rx="1.081197" width="2.162393" height="7.918844"
              fill="currentColor" fill-opacity="1.000000"></rect>
          </g>
        </svg>
      </div>
